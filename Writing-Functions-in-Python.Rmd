# Object-Oriented Programming {.unnumbered}

## Writing Functions in Python {.unnumbered}

<h3 class="course__description-title">Shayne Miel</h3>
...
# edited/added
import pandas as pd
df = pd.read_csv("archive/Writing-Functions-in-Python/datasets/students.csv")
```
...
with open('archive/Writing-Functions-in-Python/datasets/alice.txt') as file:
  text = file.read()
...
with open_read_only('archive/Writing-Functions-in-Python/datasets/my_file.txt') as my_file:
  print(my_file.read())
```
...
with stock('outputs/NVDA') as nvda:
  ...
  with open('archive/Writing-Functions-in-Python/datasets/NVDA.txt', 'w') as f_out:
    for _ in range(10):
      value = nvda.price()
...
def read_files():
  ...
  for filename in ['archive/Writing-Functions-in-Python/datasets/1984.txt', 'archive/Writing-Functions-in-Python/datasets/MobyDick.txt', 'archive/Writing-Functions-in-Python/datasets/CatsEye.txt']:
