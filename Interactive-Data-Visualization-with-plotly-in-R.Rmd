## Introduction to Plotly {.unnumbered}
...
#### What is plotly? {.unnumbered}



##### A follow-up on the course intro {.unnumbered}
...
##### Converting a ggplot2 scatterplot {.unnumbered}
...
#### Univariate graphics {.unnumbered}
...
#### Bivariate graphics {.unnumbered}



##### A first scatterplot {.unnumbered}
...
##### A first stacked bar chart {.unnumbered}
...
### Styling and customizing {.unnumbered}
...
#### Customize your traces {.unnumbered}



##### Color and opacity {.unnumbered}
...
##### Alternative color formats {.unnumbered}
...
#### Thoughtful use of color {.unnumbered}
...
##### Beyond color: Symbols {.unnumbered}
...
##### Transforming a color scale {.unnumbered}
...
#### Hover info {.unnumbered}



##### Removing a piece of hover info {.unnumbered}
...
##### Adding to hoverinfo {.unnumbered}
...
#### Customizing your layout {.unnumbered}



##### Polishing a scatterplot {.unnumbered}
...
#### Layering traces {.unnumbered}



##### Adding a linear smoother {.unnumbered}
...
##### Overlayed density plots {.unnumbered}
...
##### Plot and axis titles {.unnumbered}
...
##### Polishing axis titles {.unnumbered}
...
#### Scatterplot matrices {.unnumbered}



##### Your first SPLOM {.unnumbered}
...
##### Tweaking the appearance {.unnumbered}
...
#### Binned scatterplots {.unnumbered}



##### Binning a scatterplot {.unnumbered}
...
#### The 2018 election data {.unnumbered}



##### Did voters turn out? {.unnumbered}
...
# edited/added
library(tidyverse)
turnout = read.csv("archive/TurnoutRates.csv")
```
...
##### Adding a reference line {.unnumbered}
...
##### Which state had the highest turnout? {.unnumbered}
...
##### How much was spent on Senate races? {.unnumbered}
...
```{r}
# edited/added
fundraising = read.csv("archive/fec_candidate_summary_2018.csv")
```
...
##### Which candidate spent the most? {.unnumbered}
...
##### Mapping change in voter turnout {.unnumbered}
...
##### Mapping Senate winners {.unnumbered}
...
```{r}
# edited/added
senate_winners = read.csv("archive/senate_winners.csv")
```
...
##### Adding points to a map {.unnumbered}
...
#### From polygons to maps {.unnumbered}



##### Mapping Senate winners, redux {.unnumbered}
...
##### A county-level choropleth map {.unnumbered}
...
```{r}
# edited/added
fl_boundaries = read.csv("archive/fl_boundaries.csv")
fl_results = read.csv("archive/fl_results.csv")
```
...
##### Chapter 1: Displaying distributions {.unnumbered}
...
##### Chapter 2: Customizing your charts {.unnumbered}
...
##### Chapter 3: Advanced charts {.unnumbered}
...
##### Chapter 4: Exploring the 2018 U.S. election {.unnumbered}
