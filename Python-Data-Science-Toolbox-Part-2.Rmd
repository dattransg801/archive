...
for chunk in pd.read_csv('archive/Python-Data-Science-Toolbox-(Part-2)/datasets/tweets.csv', chunksize=10): # edited/added
...
result_counts = count_entries('archive/Python-Data-Science-Toolbox-(Part-2)/datasets/tweets.csv', 10, 'lang') # edited/added
...
```{python}
# edited/added
df = pd.read_csv('archive/Python-Data-Science-Toolbox-(Part-2)/datasets/tweets.csv')
...
with open('archive/Python-Data-Science-Toolbox-(Part-2)/world_ind_pop_data.csv') as file:
...
df_reader = pd.read_csv('archive/Python-Data-Science-Toolbox-(Part-2)/datasets/world_ind_pop_data.csv', chunksize=10)
...
urb_pop_reader = pd.read_csv('archive/Python-Data-Science-Toolbox-(Part-2)/datasets/world_ind_pop_data.csv', chunksize=1000)
...
```{python}
# Set the filename: fn
fn = 'archive/Python-Data-Science-Toolbox-(Part-2)/datasets/world_ind_pop_data.csv'
