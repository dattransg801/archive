...
## Supervised Learning in R: Classification {.unnumbered}

<h3 class="course__description-title">Brett Lantz</h3>
...
### k-Nearest Neighbors (kNN) {.unnumbered}
...
#### Classification with Nearest Neighbors {.unnumbered}



##### Recognizing a road sign with kNN {.unnumbered}
...
##### Exploring the traffic sign dataset {.unnumbered}
...
##### Classifying a collection of road signs {.unnumbered}
...
#### What about the 'k' in kNN? {.unnumbered}



##### Understanding the impact of 'k' {.unnumbered}
...
##### Testing other 'k' values {.unnumbered}
...
##### Seeing how the neighbors voted {.unnumbered}
...
#### Data preparation for kNN {.unnumbered}



##### Why normalize data? {.unnumbered}
...
#### Understanding Bayesian methods {.unnumbered}



##### Computing probabilities {.unnumbered}
...
##### Understanding dependent events {.unnumbered}
...
##### A simple Naive Bayes location model {.unnumbered}
...
##### Examining &quot;raw&quot; probabilities {.unnumbered}
...
##### Understanding independence {.unnumbered}
...
#### Understanding NB's &quot;naivety&quot; {.unnumbered}



##### Who are you calling naive? {.unnumbered}
...
##### A more sophisticated location model {.unnumbered}
...
##### Preparing for unforeseen circumstances {.unnumbered}
...
##### Understanding the Laplace correction {.unnumbered}
...
#### Applying Naive Bayes to other problems {.unnumbered}



##### Handling numeric predictors {.unnumbered}
...
#### Making binary predictions with regression {.unnumbered}



##### Building simple logistic regression models {.unnumbered}
...
##### Making a binary prediction {.unnumbered}
...
##### The limitations of accuracy {.unnumbered}
...
#### Model performance tradeoffs {.unnumbered}



##### Calculating ROC Curves and AUC {.unnumbered}
...
##### Comparing ROC curves {.unnumbered}
...
#### Dummy variables, missing data, and interactions {.unnumbered}



##### Coding categorical features {.unnumbered}
...
##### Understanding missing value indicators {.unnumbered}
...
##### Building a more sophisticated model {.unnumbered}
...
#### Automatic feature selection {.unnumbered}



##### The dangers of stepwise regression {.unnumbered}
...
##### Building a stepwise regression model {.unnumbered}
...
#### Making decisions with trees {.unnumbered}



##### Building a simple decision tree {.unnumbered}
...
```{r}
# edited/added
loans = read.csv("https://docs.google.com/spreadsheets/d/e/2PACX-1vT5pJVvzxVnFyaBcSf_znyXmgfNihy9PHJ6pEe5wnDTy-45XdJb1uQhdSYRMqulctKtlnu6slB8sQvg/pub?gid=633731493&single=true&output=csv") %>% mutate(outcome = as.factor(outcome))
good_credit = data.frame(loan_amount = "LOW", emp_length = "10+ years", home_ownership = "MORTGAGE", income = "HIGH", loan_purpose = "major_purchase", debt_to_income = "AVERAGE", credit_score = "HIGH", recent_inquiry = "NO", delinquent = "NEVER", credit_accounts = "MANY", bad_public_record = "NO", credit_utilization = "LOW", past_bankrupt = "NO", outcome = "repaid") %>% 
  mutate_at("outcome", as.factor)
bad_credit = data.frame(loan_amount = "LOW",emp_length = "6 - 9 years",home_ownership = "RENT",income = "MEDIUM",loan_purpose = "car",debt_to_income = "LOW",credit_score = "LOW",recent_inquiry = "YES",delinquent = "NEVER",credit_accounts = "FEW",bad_public_record = "NO",credit_utilization = "HIGH",past_bankrupt = "NO",outcome = "repaid") %>%
  mutate_at("outcome", as.factor)
...
##### Visualizing classification trees {.unnumbered}
...
rpart.plot(loan_model, type = 3, box.palette = c("red", "green"), fallen.leaves = F)
```

<p class="">Awesome! What do you think of the fancy visualization?
</p>

##### Understanding the tree's decisions {.unnumbered}
...
#### Growing larger classification trees {.unnumbered}



##### Why do some branches split? {.unnumbered}
...
##### Creating random test datasets {.unnumbered}
...
##### Building and evaluating a larger tree {.unnumbered}
...
##### Conducting a fair performance evaluation {.unnumbered}
...
#### Tending to classification trees {.unnumbered}



##### Preventing overgrown trees {.unnumbered}
...
##### Creating a nicely pruned tree {.unnumbered}
...
##### Why do trees benefit from pruning? {.unnumbered}
...
#### Seeing the forest from the trees {.unnumbered}



##### Understanding random forests {.unnumbered}
