...
<center>
![](archive/Intermediate-Python/datasets/lifeexp2007.png)
</center>
...
cars = pd.read_csv('archive/Intermediate-Python/datasets/cars.csv') # edited/added
...
cars = pd.read_csv('archive/Intermediate-Python/datasets/cars.csv')
...
# Fix import by including index_col
cars = pd.read_csv('archive/Intermediate-Python/datasets/cars.csv', index_col = 0)
...
# edited/added
import pandas as pd
mlb = pd.read_csv("archive/Intermediate-Python/datasets/baseball.csv")
