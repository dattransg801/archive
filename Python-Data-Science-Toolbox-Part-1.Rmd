...
df = pd.read_csv('archive/Python-Data-Science-Toolbox-(Part-1)/datasets/tweets.csv') # edited/added
...
# edited/added
tweets_df = pd.read_csv('archive/Python-Data-Science-Toolbox-(Part-1)/datasets/tweets.csv')
